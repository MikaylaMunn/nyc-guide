# Added an image link here to challenge to see if I could do this part.

boroughs = {
    'brooklyn': {
        'beaches': {
            'brighton beach': { 
                'img_link': 'https://www.defalcorealty.com/app/uploads/2019/02/brighton-beach.jpg',
            ...
            'coney island': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxLs0fD9nDGYH1rp_TSQkWLDIJUQjQbVaB4g&usqp=CAU',
            ...
            'manhattan beach': {
                'img_link': 'https://www.nycgovparks.org/photo_gallery/full_size/24750.jpg',
    ...
    'bronx': {
        'beaches': {
            'orchard beach': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEhhZVXSniZE4d2ejZeKp9QG7c56f5DOTftw&usqp=CAU',
        ...
        'zoos': {
            'bronx zoo': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkAnK_IKRNZXWL44n9r08oQVkJOPs1IprKlA&usqp=CAU',
    ...
    'manhattan': {
        'food': {
            'cheeky sandwiches': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvQhD-bPBFIdQz-_TJEFnG9Bpuun-47jjeRsJ5kozYgV1mtLa7s1l0_q4pJ2VhYM3jCys&usqp=CAU',
                'description': 'A hip sandwich shop offering a select menu of po’ boys & other Big Easy bites in a tiny storefront.'
            },
            'katz\'s delicatessen': {
                'img_link': 'https://www.fromthesquare.org/wp-content/uploads/2014/11/Katzs_Delicatessen.jpg',
                'description': 'No-frills deli with theatrically cranky service serving mile-high sandwiches since 1888.'
            },
            'veselka': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8ytx21fBunkvqrGpQV3DAuzOdz4wtAhgTsQ&usqp=CAU',
                'description': 'Borscht & pierogi are menu highlights at this cheap, no-frills Ukrainian eatery open 24 hours a day.'
            }
        },
        'parks': {
            'central park': {
                'img_link': 'https://i.pinimg.com/originals/41/dd/c5/41ddc5db82c7ee847ce64a3ccfe04f2f.jpg',
            ...
            'riverside park': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNAHguJUMqW7QHvasIYLRHMdX8DJryzpdqLQ&usqp=CAU',
            ...
            'the highline':  {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiqCc8m3lMw0w7r-0ha7rgUGJcveUuCvLzsw&usqp=CAU',
    ...
    'queens': {
        'airports': {
            'john f kennedy international airport': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnmzXkHawneOpSFs7xUFkHhxOJ4Mefy27XCQ&usqp=CAU',
            ...
            'laguardia airport': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa32IkFRlbg6qf6_72gaMpEkdhFZO3uYXWWA&usqp=CAU',
        ...
        'beaches': {
            'rockaway beaches': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSLnrmC2tWF7Ylxtu6oFHSwI0Zeh8zCHSthA&usqp=CAU',
    ...
    'staten island': {
        'beaches': {
            'cedar grove beach': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRncOYg9f5Xrh53enPCvX2Z5o96foR7yIpe_g&usqp=CAU',
            ...
            'midland beach': {
                'img_link': 'https://lh4.googleusercontent.com/-7m3BIkrs-n0/TehCtYNScYI/AAAAAAAACWU/jLXpRMFht4U/s912/Turtle%252520entry.jpg',
            ...
            'south beach': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjTcvAM38wPqL-6JZAbC6p-UAMYXI9ileY3A&usqp=CAU',
            ...
            'wolfe\'s pond beach': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFnuVQFqnnWy05yaEQZxrhRU8-6M0zHzo3GQ&usqp=CAU',
        ...
        'food': {
            'lee\'s tavern': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKMdAgqqvPh35LwaxCQcAoyeeOsS04smVOsA&usqp=CAU',
                'description': 'Family-run neighborhood pub with photos on the wall serving a range of pizza & brews.'
            },
            'ralph\'s famous italian ices': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlm3gAOWmoMSBcMbF57DJ7wUCa25aTE1NBcw&usqp=CAU',
                'description': 'Staten Island-born chain dispensing Italian ices & ice cream in 100-plus flavors since 1928.'
            },
            'royal crown bakery': {
                'img_link': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIifXHISvxC7FzCMmvFOYuFeqTquM9kapYag&usqp=CAU',
